CLASS zcl_ma_main_airplane_e7 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_MA_MAIN_AIRPLANE_E7 IMPLEMENTATION.
...
********************************************************************** from Class ZCL_MA_AIRPLANE_E6
    DATA l_airplane TYPE REF TO lcl_airplane.
    DATA l_airplanes TYPE TABLE OF REF TO lcl_airplane.

    lcl_airplane=>display_number_of_airplanes( out ).
*   lcl_airplane=>display_number_of_airplanes( EXPORTING im_out = out ).
